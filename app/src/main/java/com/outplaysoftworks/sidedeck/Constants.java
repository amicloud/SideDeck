...
public class Constants {
    ...
    public static final String KEY_DONT_SHOW_AGAIN = "dontshowagain"; //NON-NLS
    public static final String KEY_LAUNCH_COUNT = "launch_count"; //NON-NLS
    public static final String KEY_LAUNCH_COUNT_PRESSED_REMIND = "launch_count_pressed_remind";//NON-NLS
    public static final String KEY_DATE_FIRSTLAUNCH = "date_firstlaunch";//NON-NLS
